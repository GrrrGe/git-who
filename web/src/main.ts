...
function showIndexing(host: HTMLElement): () => void {
  // Cached responses should not flash a loading screen.
  const timer = window.setTimeout(() => {
    host.innerHTML = `<div class="indexing" role="status">
